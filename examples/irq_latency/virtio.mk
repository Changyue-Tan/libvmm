...
# Added uio.elf here
# These will be loaded by rootfs to home dir in linux user space
CLIENT_VM_USERLEVEL_HOME := uio.elf $(LIBVMM_TOOLS)/linux/blk/blk_integration_tests.sh $(LIBVMM_TOOLS)/linux/blk/blk_bench.sh
...
# Changed libsddf_util_debug.a to libsddf_util.a to allow sddf_print in bench mode
...
IMAGES := client_vmm.elf timer_driver.elf blk_driver.elf blk_virt.elf serial_driver.elf serial_virt_tx.elf serial_virt_rx.elf \
	network_virt_rx.elf network_virt_tx.elf eth_driver.elf network_copy.elf uio.elf
...
# Added uio.c to be compiled for ARM
uio.elf: $(VIRTIO_EXAMPLE)/uio.c
	aarch64-linux-gnu-gcc $(VIRTIO_EXAMPLE)/uio.c -o uio.elf
...
# This loads the user programs into linux home dir
